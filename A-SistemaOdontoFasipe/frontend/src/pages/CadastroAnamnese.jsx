    ...
    <section className='container_cadastro_paciente'>
      <div className='container_button_form'>
        ...
        <form className='form' method='POST' onSubmit={handleSubmit}>
          ...
          <input type="text" id="anm_dores_face" name="anm_dores_face" maxLength="100" placeholder='Paciente possui dores na face' value={formData.anm_dores_face} onChange={handleInputChange} />
          ...
          <input type="text" id="anm_degluticao" name="anm_degluticao" maxLength="100" placeholder='Deglutição do paciente' value={formData.anm_degluticao} onChange={handleInputChange} />
          
          {/* Assimetria do paciente */}
          <input type="text" id="anm_assimetria" name="anm_assimetria" maxLength="100" placeholder='Assimetria do paciente' value={formData.anm_assimetria} onChange={handleInputChange} />
          
          {/* ATM do paciente */}
          <input type="text" id="anm_atm" name="anm_atm" maxLength="100" placeholder='ATM do paciente' value={formData.anm_atm} onChange={handleInputChange} />
